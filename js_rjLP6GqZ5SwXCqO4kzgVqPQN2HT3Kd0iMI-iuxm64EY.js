        ...
        */
        function performMovement(v){
            ...
            if (options.css3 && options.autoScrolling && !options.scrollBar) {
                ...
                console.log(v.dtop);
               /* if(v.dtop > 700 && v.dtop < 4620){
                    $(".test").css({"position":"fixed","top":v.dtop+600});
                }else if(v.dtop > 4620){
                    $(".test").css({"position":"absolute","top":618});
                }*/
...
$(window).load(function() {
  $('.blog-list').owlCarousel({
   ...
   // Add display none to hide-nav navigation class if the content is less than 3.
  $(".owl-stage").each(function(){
    var count = $(this).children(".owl-item").length;
    if(count <= 3) {
      $(this).parents().eq(1).addClass('hide-nav');
    }
  });
});
...
$(window).load(function(){
	...
	/* home page top notification close button */
$('#close-btn-note').click(function () {
        $('#top-notification').hide();
	$('.year-comp-mobile').css('margin-top', '0');
	$('.main-wrapper').css('margin-top', '0');
	$('.dropcontent').css('margin-top', '0');
        event.stopPropagation();
    });
...
function counterStart() {
  var parentClass = '';
  if (_countGlob == 590) {
    parentClass = '.who-we-are'
    counterHit(parentClass)
  } else if (_countGlob == 2360) {
    parentClass = '.client'
    counterHit(parentClass)
  }
}

function counterHit(parentClass) {
  $(parentClass + ' .counts').each(function () {
...
function showFloatContent() {
  if ($(window).width() < mob) {
    $(window).scroll(function () {
      if ($('body').height() <= ($(window).height() + $(window).scrollTop())) {
        $(".main-menu-contact-drop .container").css("display", "block");
        $(".main-menu-share-drop .container").css("display", "block");
      } else {
        $(".main-menu-contact-drop .container").css("display", "block");
        $(".main-menu-share-drop .container").css("display", "block");
      }
...
/* Run owl carousel for small width and destroy above 567 */
function checkWidth() {
  var windowSize = $(window).width();
  if (windowSize <= 567) {

    $('.frame-wrok-lists').owlCarousel({
      loop: true,
      margin: 5,
      nav: true,
      autoplay: true,
    ...
    $('.frame-wrok-lists').trigger('destroy.owl.carousel').removeClass('owl-carousel owl-loaded');
    $('.frame-wrok-lists').find('.owl-stage-outer').children().unwrap();
  }
}
checkWidth();
$(window).resize(checkWidth);

// Run owl carousel for small width and destroy above 767 for employee container*/
function chkWidth() {
  var windowSize = $(window).width();
  if (windowSize <= 767) {


    $('.employee-outer-container').owlCarousel({
      loop: true,
      margin: 0,
      nav: false,
      dots:true,
    ...
    $('.employee-outer-container').trigger('destroy.owl.carousel').removeClass('owl-carousel owl-loaded');
    $('.employee-outer-container').find('.owl-stage-outer').children().unwrap();
  }
}
chkWidth();
...
$(document).ready(function () {
    ...
    var redirect_path = getUrlParameter('path');
   
    if (redirect_path  !== '') {
        $.cookie('redirect_path', redirect_path , {expires: 1, path: '/'});
    }
});
function menuBeh() {
  var winWidth = $(window).width();
  var mobileMenuBool = $('.header-nav').find('footer')
  if (winWidth < 980) {
    // alert("mob"+winWidth)
    $(".header-nav .main-menu").show();
    if (mobileMenuBool.length == 0) {
      $(".main-menu").clone().appendTo(".header-nav");
      $('.header-nav .main-menu-links > h5').click(function () {
        $(this).parent().siblings().find()
        $(this).siblings().slideToggle('show');
      });
    }
    $('.header-nav .top-links').hide();
    $('.header-nav').removeClass('desk');
  } else {

    $('.header-nav .top-links').show();
    $('.header-nav').addClass('desk');
    $(".header-nav .main-menu").hide();
    // alert(winWidth)
  }
}
...
$(document).ready(function () {
  ...
  $(document).on('click', "button.close-btn", function (e) {
    if (!parent.$('body').hasClass("front") && !parent.$('body').hasClass("page-node-51")) {
      parent.$('body').addClass('not-front');
    }

  });
  $(".detail-content").click(function () {
    var id = $(this).attr('data-id');
    localStorage.setItem("selected_owl_id", id);
  });

  $(".work-detail-content").click(function () {
    var id = $(this).attr('data-id');
    localStorage.setItem("select_owl_id", id);
  });
  ...
  $(".menuscrollContainer").scrollBox();
  
  // what right section home page
// if ( $("div").hasClass( "what-right" )) {
//     const ps = new PerfectScrollbar('.what-right', {
//     wheelSpeed: 2,
//     wheelPropagation: true,
//     suppressScrollY: false,
...
// }
  ...
  $('ul.team-links li').click(function (e) {
    e.preventDefault();
  });
  // on click of sub menu menu hides and shows the section
  $('.region-submenu ul li').click(function () {
    /*var dataOpen = $(this).parent().parent().parent().attr('class');
     if ($(this).hasClass("active")) {
     if (dataOpen !== undefined) {
     $('.' + dataOpen).removeClass('active');
     $(this).removeClass('active');
     $(this).css("background-position", "94% 12px");
     }
     } else {
     if (dataOpen !== undefined) {
     $(".top-links > li").removeClass('active');
     $(this).addClass('active');
     $('.dropcontent').removeClass('active');
     $('.' + dataOpen).addClass('active');
     $('.top-links > li').css("background-position", "94% 12px");
     $(this).css("background-position", "94% -23px");
     }
     }*/
  });

//    $('.top-links ul li').click(function(){
...
//    });
  ...
  $('.subscribe-btn a.sub-button').click(function () {
    //console.log('open');
    $('body').removeClass('not-front');
    $('body').removeClass('scrollbody');
    $('body').css({
  ...
  $(".webform-client-form-59 .form-actions .contact-us-59.control").append("<div class='hide-loader'><img src='//www.neosofttech.com/sites/all/themes/neosoft2017/images/dual_ring.gif'></div>");
  $(".webform-client-form-59 input.form-submit").click(function () {
    ...
    gtag('event', 'conversion', {
      'send_to': 'AW-794643987/6LWxCN_E3ZEBEJOc9foC',
    ...
    if ($("label.error").is(':visible')) {
      console.log("Fail");
      $("div.hide-loader").css('display', 'none');
    } else {
      console.log("Pass");
      $("div.hide-loader").css('display', 'block');
    }
    var email = $("input#edit-submitted-email").val();
    if (email == '') {
      $("div.hide-loader").css('display', 'none');
    }
  });

  $(".webform-client-form-88 .form-actions").append("<div class='hide-loader'><img src='//www.neosofttech.com/sites/all/themes/neosoft2017/images/dual_ring.gif'></div>");
  $(".webform-client-form-88 input.form-submit").click(function () {
    if ($("label.error").is(':visible')) {
      console.log("Fail");
      $("div.hide-loader").css('display', 'none');
    } else {
  ...
  // Get started when click open contact us form
  $('.step-btn').click(function (e) {
    $('#contact-us-top')[0].click();
  });
  $('.step-btn').bind("contextmenu", function(e) {
      e.preventDefault();
  });
  var l = window.location; console.log(l);
  var base_url = l.protocol + "//" + l.host + "/" + l.pathname.split('/')[1];
  var base_domain = 'neosofttech.com';

  //confirm message
  $('.browseJobs').click(function (e) { e.preventDefault();
    var redirect = $(this).attr('href');
    //console.log(redirect);
    var new_redirect = 'https://careers.neosofttech.com';
    //console.log(new_redirect);
    // Check base url before redirect
    //if (base_domain == l.hostname) {
      lnv.confirm({
        content: "We're now taking you to <br> another NeoSOFT website.",
        confirmBtnText: 'Ok',
        cancelBtnText: 'Cancel',
        confirmHandler: function () {
          // confirm callback
          //window.location.href = "career-view";
          window.open(new_redirect,'_blank');
        },
  ...
  $('.browseblogs').click(function (e) {
    var redirect = $(this).attr('href');
    console.log(redirect);
    var new_redirect = redirect.replace(l.hostname, 'blogs.'+l.hostname);
    console.log(new_redirect);
    // Check base url before redirect
    if (base_domain == l.hostname) {
      lnv.confirm({
        content: "We're taking you to <br> another NeoSOFT website now.",
        confirmBtnText: 'Ok',
        cancelBtnText: 'Cancel',
        confirmHandler: function () {
          // confirm callback
  ...
  if (typeof $.cookie('agree') === 'undefined') {
    $('#block-block-24').css('display', 'block');
  } else {
    //have cookie
    $('#block-block-24').hide();
  }
  $(".agree").on('click', function () {
    $('#block-block-24').hide();
    $.cookie('agree', 'agreed', {expires: 365, path: '/'});
  });

  $(".btn.btn-yes").on('click', function () { console.log('yes');
    $('#block-block-24').hide();
    $('.btn.btn-yes').text("Loading...");
    $('.btn.btn-no').hide();
    document.location.href="http://neosofttech.com";
    $.cookie('agree', 'agreed', {expires: 365, path: '/'});
  });
  $(".btn.btn-no").on('click', function () { console.log('no');
    $('#block-block-24').show();
    $('.btn.btn-no').text("Loading...");
    $('.btn.btn-yes').hide();
    document.location.href="http://neosofttech.com";
    $.cookie('agree', '', {expires: -1, path: '/'});
  });
  
  $("#webform-client-form-59 textarea").keydown(function (e) {
    var rows = $(this).val().split("\n").length;
    if (e.which == 13 && rows == 2)
    {
      return false;
    }
  });
    ...
    attach: function (context, settings) {
      ...
      $('.webform-client-form', context).once('webform_ajax', function () {
        if (typeof grecaptcha != "undefined") {
          grecaptcha.render('google_recaptcha_webform_client_form_80', {'sitekey': '6Ld9pDUUAAAAAHYuotfouYWwHhz5Pj6BLLiktWBk', 'theme': 'dark', 'script': false});
          $("#google_recaptcha_webform_client_form_80").wrap('<div class="col col-large-6 col-medium-6 col-small-12"><div class="control"></div></div>');
        }
      });
    }
  ...
  $('.conditional_services').css('display', '');    
  $('#edit-submitted-inquiry-type').change(function () {
    var selected = $(this).val();
    if (selected == "request_for_services") {
      $('.conditional_services').show();
      $('.conditional_are_you_an_existing_customer').show();
      $('.conditional_industries').show();
    } else {
      $('.col-small-12.conditional_services').css("display", "none");
      $('.conditional_are_you_an_existing_customer').hide();
      $('.conditional_industries').hide();
    }
  });
  $('#edit-submitted-department').SumoSelect();
  $('#edit-submitted-monthly-budget').SumoSelect();
  // Add Sumoselect for Services multiple select
  $('#edit-submitted-services').SumoSelect();
  $('#edit-submitted-technologies').SumoSelect({placeholder: 'Select here*'});
  $('#edit-submitted-countries').SumoSelect({placeholder: 'Country'});
  $('#edit-submitted-country').SumoSelect({placeholder: 'Country'});
  $("#google_recaptcha_webform_client_form_59").wrap('<div class="col col-large-6 col-medium-6 col-small-12"><div class="control"></div></div>');
  $("#google_recaptcha_webform_client_form_80").wrap('<div class="col col-large-6 col-medium-6 col-small-12"><div class="control"></div></div>');
  $("#google_recaptcha_webform_client_form_88").wrap('<div class="col col-large-6 col-medium-6 col-small-12"><div class="control"></div></div>');
  
/*  $('#fullpage').fullpage({
    anchors: ['Home', 'Who We Are', 'What We Do', 'We Work With', 'Who We Have Helped', 'Why Choose Us', 'Blog', 'Footer'],
    sectionsColor: ['#ffffff', '#f8f8f8', '#ffffff', '#333333', '#f8f8f8', '#fdfdfd', '#f8f8f8'],
    navigation: true,
    navigationPosition: 'right',
    ...
    onLeave: function (index, nextIndex, direction) {
      ...
      if (index == 6 && direction == "down") {
        $('.top-icons.desktop-view').hide();
      }
      if (nextIndex == 7 && direction == "down") {
        $('.top-icons.desktop-view').show();
      }
  ...
  /*$('.product-engineering-carousel').owlCarousel({
   loop: true,
   mouseDrag: true,
   margin: 0,
   nav: true,
...
/*  $('#fullpage--we-work-with').fullpage({
    anchors: ['Enterprises', 'Agency', 'Startup', 'Footer'],
    navigation: true,
    navigationPosition: 'right',
    navigationTooltips: ['Enterprises', 'Agency', 'Startup', 'Footer'],
    css3: true,
  });*/

  // function adjustHeight() {
  //     var bottomHeight = $('.login-drop .info-procedure').outerHeight(true);
  //     var vhHeight = $('.login-drop.other-drop').outerHeight(true);
  //     $('.login-dropdown').css("height", vhHeight - bottomHeight + "px");
  // //     $('.login-dropdown').addClass("test");
  //  }
...
//   enablefullpage();
  ...
  //menu-dropdown
  $('.main-header .menu').click(function (event) {
    event.stopPropagation();
    $('.menu-dropdown').toggleClass('active');
  });
  ...
  $('.top-links > li').click(function () {
    var dataOpen = $(this).attr('data-content');
    if ($(this).hasClass("active")) {
      if (dataOpen !== undefined) {
        $('.' + dataOpen).removeClass('active');
        $(this).removeClass('active');
        $(this).css("background-position", "94% 10px");
      }
    } else {
      if (dataOpen !== undefined) {
        $(".top-links > li").removeClass('active');
        ...
        $('.dropcontent').removeClass('active');
        $('.' + dataOpen).addClass('active');
        $('.top-links > li').css("background-position", "94% 10px");
        $(this).css("background-position", "94% -25px");
      }
    }
  });

  $(".top-bar").hover(function (event) {
    //$(".dropcontent").removeClass('active');
    //$('.top-links > li').removeClass("active");
    //$(".top-links > li").css("background-position", "94% 10px");
  });
...
//   });
  ...
  $('.login-drop').click(function (event) {
    event.stopPropagation();
  });
  ...
  $('.country').click(function (event) {
    ...
    $('.account').removeClass('active');
    $('.search').removeClass('active');
    $('.country-drop').toggleClass('active');
    $('.country-main').toggleClass('active');
  });

  $('.country-drop').click(function (event) {
    event.stopPropagation();
  });

  $(document).click(function () {
    $('.country-drop').removeClass('active');
    $('.country-main').removeClass('active');
  });

  /*jQuery(".tab-section li a").click(function () {
   var sel = jQuery(this).attr("title");
   var el = jQuery("#"+sel);
   jQuery(".tab-section .tab-navigation li").removeClass("active");
   jQuery(this).addClass("active");
   jQuery(".tab.active").fadeOut(800, function () {
   jQuery(this).removeClass("active");
   el.addClass("active").fadeIn(800);
   });
   }); */

  $(".material-ui input").keyup(function () {
    if ($(this).val() != "") {
      $(this).addClass("active");
    } else {
      $(this).removeClass("active");
  ...
  $('.main-menu-chat').click(function (event) {
    event.stopPropagation();
    $('.main-menu-share-drop').removeClass('active');
    $('.main-menu-share').removeClass('active');
    $(this).toggleClass('active');
    $('.main-menu-contact-drop').toggleClass('active');
  });

  $('.main-menu-contact-drop').click(function (event) {
    event.stopPropagation();
  });

  $(document).click(function () {
    $('.main-menu-contact-drop').removeClass('active');
    $('.main-menu-chat').removeClass('active');
  });

  $('.main-menu-share').click(function (event) {
    event.stopPropagation();
    $('.main-menu-contact-drop').removeClass('active');
    $('.main-menu-chat').removeClass('active');
    $(this).toggleClass('active');
    $('.main-menu-share-drop').toggleClass('active');
  });

  $('.main-menu-share-drop').click(function (event) {
    event.stopPropagation();
  });
  ...
  function seticonposition() {
    //console.log($("#fullpage").scrollTop());
    //$(".floating-icons").css("position","fixed");
  }
  ;
  setInterval(seticonposition, 100);


  $(".main-menu-contact-box").hover(function () {
    $(".contact-info-panel").toggle();
  });

  $(".main-menu-share-box").hover(function () {
    $(".share-info-panel").toggle();
  });

  // $('.menu-icon1').click(function(event) {
  //     event.stopPropagation();
  //     $('header .main-header ul').toggleClass('active');
  // });

  $('.menu-icon1').click(function (event) {
    event.stopPropagation();
    if ($("header .main-header .header-nav").toggleClass("active")) {
  ...
  $('.close-icon').click(function (event) {
    event.stopPropagation();
    $('header .main-header .header-nav').removeClass('active');
  });
  ...
  $('.close-icon').click(function (event) {
    ...
    /* $('.global-customers-slider').owlCarousel({
        loop: false,
        margin: 10,
        // autoplay:true,
  ...
  // $(document).click(function() {
  //     $('header .main-header ul').removeClass('active');
  // });
  ...
  $(".accordion-head").click(function () {
    ...
    //            $(".accordion-head").children(".arrow").removeClass("hide");
    //        }
    if ($(this).next(".accordion-body").is(':visible')) {
      ...
      $(this).children(".arrow").toggleClass("hide");
    }
  });

  /* smooth scroll for industry-page menu */
  jQuery(function ($) {
    $('ul.dropdown-industries-list li a[href*="#"]:not([href="#"])').click(function () {
      if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
        var target = $(this.hash);
        $(".we-work-with-submenu").removeClass("active");
        $(".wework").removeClass("active");
        $(".wework").css("background-position", "94% 10px");
    ...
    $('ul.we-work-with-links li a[href*="#"]:not([href="#"])').click(function () {
      if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
        var target = $(this.hash);
        $(".we-work-with-submenu").removeClass("active");
        $(".wework").removeClass("active");
...
//                    }, 1000);
  ...
  /* smooth scroll for any page industry menu to industry-page menu desc  */
  var jump = function (e) {
    if (e) {
      e.preventDefault();
  ...
  $(document).ready(function () {
    // $('').bind("click", jump);
 $('#fullpage').fullpage({
        anchors: ['Home', 'Who-We-Are', 'What-We-Do', 'We-Work-With', 'Who-We-Have-Helped', 'Why-Choose-Us', 'Blog', 'Sitemap'],
        sectionsColor: ['#ffffff', '#f8f8f8', '#f6f6f8', '#333333', '#f8f8f8', '#fdfdfd', '#f8f8f8'],
        navigation: true,
        navigationPosition: 'right',
        navigationTooltips: ['Home', 'Who We Are', 'What We Do', 'We Work With', 'Who We Have Helped', 'Why Choose Us', 'Blog', 'Sitemap'],
...
(function ($) {
    jQuery(document).ready(function ($) {
        ...
        $("#edit-firstname").on('blur', function () {
            var firstname = $('#edit-firstname').val();
            if (firstname == '') {
                $("#emty_firstname_error").remove();
                $('#edit-firstname').after('<div style="color:red;" id="emty_firstname_error">First Name cannot be empty</div>');
        ...
        $("#edit-lastname").on('blur', function () {
            var lastname = $('#edit-lastname').val();
            if (lastname == '') {
                $("#emty_lastname_error").remove();
                $('#edit-lastname').after('<div style="color:red;" id="emty_lastname_error">Last Name cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_lastname_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $("#edit-field-company input").on('blur', function () {
            var company = $('#edit-field-company input').val();
            if (company == '') {
                $("#emty_company_error").remove();
                $('#edit-field-company input').after('<div style="color:red;" id="emty_company_error">Company cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_company_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $("#edit-field-departments-und").on('blur', function () {
            var department = $('#edit-field-departments-und').val();
            if (department == '_none') {
                $("#emty_department_error").remove();
                $('#edit-field-departments-und').after('<div style="color:red;" id="emty_department_error">Department cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_department_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $("#edit-field-job-role-list-und").on('blur', function () {
            var job = $('#edit-field-job-role-list-und').val();
            if (job == '_none') {
                $("#emty_job_error").remove();
                $('#edit-field-job-role-list-und').after('<div style="color:red;" id="emty_job_error">Job Role cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_job_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $("#edit-email").on('blur', function () {
            ...
            if (email == '') {
                $("#emty_email_error").remove();
                $('#edit-email').after('<div style="color:red;" id="emty_email_error">Email cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_email_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $("#edit-field-country-list-und").on('blur', function () {
            var country = $('#edit-field-country-list-und').val();
            if (country == '_none') {
                $("#emty_country_error").remove();
                $('#edit-field-country-list-und').after('<div style="color:red;" id="emty_country_error">Country cannot be empty</div>');
                $("input[type=submit]").attr("disabled", "disabled");
            } else {
                $("#emty_country_error").remove();
                $(':input[type="submit"]').prop('disabled', false);
        ...
        $('#newsletter-manage-subscriptions-form').submit(function (e) {
           var $form = $(this);
           $("#edit-email").blur();
           $("#edit-firstname").blur();
           $("#edit-lastname").blur();
           $("#edit-field-company input").blur();
           $("#edit-field-departments-und").blur();
           $("#edit-field-job-role-list-und").blur();
           $("#edit-field-country-list-und").blur();
           
           var check_disabled = $(':input[type="submit"]').attr("disabled");
  ...
  Dialog.prototype = {
    render: function () {
      ...
      this.boundingBox = $(
              ...
              '<div class="lnv-dialog-hd">' + this.cfg.title + '</div>' +
